...
//         public float WaterDrag = 4f;
//         public Transform[] FloatPoints;
//         //Mesh gigante 11 ficou bom pois barco fica em cima da agua
//         public float buoyancyMultiplier = 11f; //1.5 ajuste fino: maior -> mais empuxo
